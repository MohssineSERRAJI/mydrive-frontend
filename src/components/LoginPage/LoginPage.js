...
import ErrorRed from "../../images/error-red.png";
                  ...
                  <form action="">
                    ...
                    <div class="resend__email">
                      ...
                      >
                        ...
                        <span class="full__timer">
                          0:
                          <span class="seconds__span">
                            {props.state.verifyEmailResentTimer}
                          </span>
                        </span>
                      </p>
                      <a class="resend__button" onClick={props.resendEmail}>
                        Resend confirmation email
                      </a>
                      <a class="resend__button" onClick={props.logout}>
                        Logout
                      </a>
                    </div>
                  </form>
                ...
                >
                  ...
                  <form onSubmit={props.login}>
                    ...
                    {!props.state.resetPasswordMode ? (
                      <div class="group__input forgot__pass">
                        <input
                          type="password"
                      ...
                      props.loginFailedCode === 404 ? (
                        <div>
                          <div className="login__image__wrapper">
                            <img className="login__image" src={ErrorRed} />
