...
import { setFiles, startResetCache, startSetFileAndFolderItems } from "../../actions/files";
...
class SettingsPageContainer extends React.Component {
  ...
  getUserDetails = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        this.props.dispatch(setParent(v4()));
  ...
  setSettings = () => {
    ...
    const doubleClickFolders = window.localStorage.getItem(
      "double-click-folders"
    );
    const hideFolderTree = window.localStorage.getItem("hide-folder-tree");
    const showFolderTreeScrollBars = window.localStorage.getItem(
      "show-folder-tree-scroll-bars"
    );
  ...
  submitS3Account = (e) => {
    ...
    axios
      .post("/user-service/add-s3-storage", data)
      .then((response) => {
        Swal.fire(
          "S3 Account Added",
  ...
  getInvoiceData = () => {
    if (!env.commercialMode || !this.state.userDetails.activeSubscription)
      return;

    axios
      .get("/user-service/payments")
      .then((response) => {
  ...
  removeS3Account = (e) => {
    ...
    Swal.fire({
      ...
      if (result.value) {
        axios
          .delete("/user-service/remove-s3-storage")
          .then((response) => {
            let newUser = this.state.userDetails;
  ...
  refreshStorageSize = () => {
    axios
      .get("/user-service/refresh-storage-size", undefined)
      .then((response) => {
        this.getUserDetails();
      })
      .catch((err) => {
  ...
  submitGoogleAccount = (e) => {
    ...
    axios
      .post("/user-service/create-google-storage-url", data)
      .then((response) => {
  ...
  getStoragePercentage = () => {
    let value = Math.floor(
      (this.state.userDetails.storageData.storageSize /
        this.state.userDetails.storageData.storageLimit) *
        100
    );
  ...
  getStoragePercentageGoogle = () => {
    let value = Math.floor(
      (this.state.userDetails.storageDataGoogle.storageSize /
        this.state.userDetails.storageDataGoogle.storageLimit) *
        100
    );
  ...
  goHome = () => {
    this.props.dispatch(
      startSetFileAndFolderItems("", "/", "DEFAULT", undefined)
    )
  ...
  submitPasswordChange = (e) => {
    ...
    if (
      ...
      this.state.verifyNewPassword.length === 0
    ) {
      Swal.fire({
        icon: "error",
        title: "Error",
    ...
    axios
      .post(`/user-service/change-password`, data)
      .then((results) => {
  ...
  submitAddName = (e) => {
    ...
    axios
      .post("/user-service/add-name", data)
      .then((response) => {
  ...
  uploadPersonalFileList = (e) => {
    ...
    if (
      this.uploadReference.current.files &&
      this.uploadReference.current.files[0]
    ) {
      ...
      axios
        .post("/user-service/upload-personal-file-list", currentFile, config)
        .then((response) => {
  ...
  removeS3Metadata = (e) => {
    ...
    Swal.fire({
      ...
      if (result.value) {
        axios
          .delete("/user-service/remove-s3-metadata")
          .then((response) => {
            Swal.fire(
              "S3 Metadata removed",
              ...
              <div class="file__settings">
                ...
                <div class="settings__menu">
                  <ul>
                    ...
                    >
                      <a onMouseDown={() => this.modeChange("general")}>
                        General
                      </a>
                    </li>
                    <li
                    ...
                    >
                      <a onMouseDown={() => this.modeChange("storage")}>
                        Storage accounts
                      </a>
                    </li>
                    <li
                    ...
                    >
                      <a onMouseDown={() => this.modeChange("billing")}>
                        Billing & payments
                      </a>
                    </li>
                    <li
                      ...
                      data-settings="notification__settings"
                    >
                      <a onMouseDown={() => this.modeChange("notifications")}>
                        Settings
                      </a>
                    </li>
                  </ul>
              ...
              <div class="file__settings">
                ...
                <div class="settings__menu">
                  <ul>
                    ...
                    >
                      <a
                        onMouseDown={() => this.modeChangeFullScreen("general")}
                      >
                        General
                      </a>
                    </li>
                    ...
                    >
                      <a
                        onMouseDown={() => this.modeChangeFullScreen("storage")}
                      >
                        Storage accounts
                      </a>
                    </li>
                    ...
                    >
                      <a
                        onMouseDown={() => this.modeChangeFullScreen("billing")}
                      >
                        Billing & payments
                      </a>
                    </li>
                    ...
                    >
                      <a
                        onMouseDown={() =>
                          this.modeChangeFullScreen("notifications")
                        }
                      >
                        Settings
                      </a>
                        ...
                        <p>
                          {this.state.loaded
                            ? this.state.userDetails.name
                              ? capitalize(this.state.userDetails.name)
                              : "No Name Set"
                            : "Loading..."}
                        </p>
                      </div>
                          ...
                          <div class="double__title">
                            ...
                            <span>
                              {!this.state.loaded
                                ? "Loading..."
                                : env.commercialMode &&
                                  this.state.userDetails.activeSubscription
                                ? "Plan Type"
                                : ""}
                            </span>
                          </div>
                    ...
                    this.state.userDetails.storageData.storageLimit
                        ...
                        <div class="value__updater">
                          <a
                            onClick={
                              env.commercialMode
                                ? this.launchStoragePage
                                : this.refreshStorageSize
                            }
                          >
                            {env.commercialMode ? "Upgrade" : "Refresh"}
                          </a>
                        </div>
                      </div>
                    ...
                    <div class="elem__control--settings">
                      <div class="control__title">
                        <div class="double__title">
                          ...
                          <span>
                            {!this.state.loaded
                              ? "Loading..."
                              : this.state.userDetails.s3Enabled
                              ? this.state.userDetails.s3Data.bucket
                              : "S3 Not Enabled"}
                          </span>
                        </div>
                      </div>
                      ...
                      >
                        <div class="available__space--wrap">
                          ...
                          <span>
                            {this.state.userDetails.s3Enabled
                              ? !this.state.userDetails.storageDataPersonal
                                  .failed
                                ? `${bytes(
                                    this.state.userDetails.storageDataPersonal
                                      .storageSize
                        ...
                        <p>
                          {this.state.loaded && this.state.invoicesLoaded
                            ? !this.state.invoiceData.card
                              ? "No Payment Method"
                              : `${this.state.invoiceData.card.brand} ending in ${this.state.invoiceData.card.last4}`
                            : "No Payment Method"}
                        </p>
                      </div>
                      <div class="value__updater">
                        ...
                        <p>
                          {this.state.loaded && this.state.invoicesLoaded
                            ? !this.state.invoiceData.subscription
                              ? "No Subscription"
                              : capitalize(
                                  this.state.invoiceData.subscription.plan
                                    .interval
                                )
                            : "No Subscription"}
                        </p>
                    ...
                    <div class="settings__switchers">
                      ...
                      <p>
                        <input
                          ...
                          onChange={this.listViewOnChange}
                          type="checkbox"
                          id="test1"
                        />
                      ...
                      <p>
                        <input
                          ...
                          onChange={this.sortByDateChange}
                          type="checkbox"
                          id="test2"
                        />
                        <label for="test2">Sort By Date</label>
                      </p>
                      <p>
                        <input
                          checked={this.state.descendingSort}
                          onChange={this.sortByDescendingChange}
                          type="checkbox"
                          id="test3"
                        />
                        <label for="test3">Descending Order</label>
                      </p>
                      <p>
                        <input
                          checked={this.state.dropToUpload}
                          onChange={this.dropOnChange}
                          type="checkbox"
                          id="test4"
                        />
                      ...
                      <p>
                        <input
                          checked={this.state.doubleClickFolders}
                          onChange={this.doubleClickOnChange}
                          type="checkbox"
                          id="test5"
                        />
                        <label for="test5">
                          Double Click To Enter Folders On Mobile
                        </label>
                      </p>
                      <p>
                        <input
                          checked={this.state.hideFolderTree}
                          onChange={this.hideFolderTreeOnChange}
                          type="checkbox"
                          id="test6"
                        />
                      ...
                      <p>
                        <input
                          checked={this.state.showFolderTreeScrollBars}
                          onChange={this.showFolderTreeScrollBarsOnChange}
                          type="checkbox"
                          id="test7"
                        />
            ...
            <div class="password__modal">
              ...
              <div class="password__content">
                <form
                  onSubmit={
                    !this.state.loaded
                      ? this.submitS3Account
                      : this.state.userDetails.s3Enabled
                      ? this.removeS3Account
                      : this.submitS3Account
                  }
                >
                  <div
                  ...
                  >
                    <input
                      value={this.state.s3ID}
                      onChange={this.onChangeS3ID}
                      placeholder="S3 ID"
                    />
                  </div>
                  <div
                ...
                <form
                  onSubmit={this.downloadPersonalFileList}
                  style={
                    !this.state.loaded
                      ? { display: "none" }
                      : this.state.userDetails.s3Enabled
                  ...
                  <div class="password__submit">
                    <div>
                      <input
                        ...
                        onChange={this.uploadPersonalFileList}
                        type="file"
                        multiple={false}
                      />
                ...
                <form
                  onSubmit={this.removeS3Metadata}
                  style={
                    !this.state.loaded
                      ? { display: "none" }
                      : this.state.userDetails.s3Enabled
...
export default connect(connectStoreToProp)(withRouter(SettingsPageContainer));
