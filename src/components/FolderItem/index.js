...
import { startRenameFolder, startRemoveFolder, removeFolder } from "../../actions/folders";
...
class FolderItemContainer extends React.Component {
  ...
  getContextMenu = (e) => {
    ...
    this.props.dispatch(startSetSelectedItem(this.props.id, false));
    this.props.dispatch(setLastSelected(0));
    this.props.dispatch(setRightSelected(this.props.id));
  };
  ...
  changeEditNameMode = async () => {
    ...
    this.props.dispatch(startRenameFolder(this.props.id, folderName));
  };
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        this.props.dispatch(
          startRemoveFolder(
            this.props.id,
            [...this.props.parent_list, this.props.id],
            this.props.parent
          )
        );
      }
...
export default connect(connectPropToState)(withRouter(withRouter(FolderItemContainer)));
