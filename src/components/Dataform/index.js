...
class DataFormContainer extends React.Component {
  ...
  componentDidMount = () => {
    ...
    this.props.dispatch(startSetFiles(parent, "DEFAULT", search));
    this.props.dispatch(startSetFolders(parent, "DEFAULT", search));
  };
...
export default connect(mapStateToProp)(withRouter(DataFormContainer));
