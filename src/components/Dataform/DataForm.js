...
import SortIcon from "../../assets/sortarrow.svg";
    ...
    >
      <div class="head__folders">
        <h2 className="noSelect">
          {props.folders.length === 0 ? "No Folders" : "Folders"}
        </h2>
      </div>
        ...
        {props.folders.map((folder) => (
          <>
            <FolderItem
              ...
              key={folder.pk}
              id={folder.pk}
              itemSelected={folder.pk === props.selected}
    ...
    <div className="file__view noSelect">
      <div class="recent__table--wrap">
        {props.parent === "/" ? (
          ...
          <div
            class="head__recent--files noSelect"
            style={props.loading ? { display: "none" } : { marginTop: "20px" }}
          >
            <ParentBar />
            <div class="view__recent">
              <ul>
          ...
          >
            ...
            {props.files.map((file) => (
              <FileItem
                {...file}
                key={file.pk}
                itemSelected={file.pk === props.selected}
                downloadFile={props.downloadFile}
                removeFile={props.removeFile}
                fileClick={props.fileClick}
              />
