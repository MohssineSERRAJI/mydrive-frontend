...
import PDFIcon from "../../assets/extension1.svg";
import DOCIcon from "../../assets/extension2.svg";
import DOCXIcon from "../../assets/extension2.svg";
import XLSIcon from "../../assets/extension3.svg";
import PTTIcon from "../../assets/extension4.svg";
import ZIPIcon from "../../assets/extension5.svg";
...
class FileItemContainer extends React.Component {
  ...
  shouldComponentUpdate = (nextProp, nextState) => {
    return (
      ...
      this.props.fields.transcoded !== nextProp.fields.transcode ||
  ...
  componentDidUpdate = (nextProp) => {
    ...
    if (hasThumbnail && !this.failedToLoad && !this.imageLoaded) {
      ...
      this.setState(() => ({
        ...this.state,
        imageClassname: this.props.listView
  ...
  saveNameEdit = () => {
    ...
    this.props.dispatch(
      startRenameFile(this.props._id, value, this.props.metadata.drive)
    );
  ...
  startMovingFile = () => {
    ...
    this.props.dispatch(setMoverID(this.props.pk, this.props.parent, true));
  };
  ...
  changeMoverPos = () => {
    this.setState(() => {
      return {
        ...this.state,
        movingPercentage:
          this.state.movingPercentage >= 80
            ? 0
            : this.state.movingPercentage + 1,
      };
    });
  };
  ...
  getExtensionImage = () => {
    const ext = this.getFileExtension(this.props.fields.filename);
  ...
  startFileClick = () => {
    this.props.fileClick(this.props.pk, this.props);
  };
...
export default connect(connectStateToProp)(withRouter(FileItemContainer));
