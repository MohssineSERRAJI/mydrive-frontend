  ...
  if (props.state.movingMode) {
        ...
        <td>
          <div class="inner__moving">
            <div class="moving__info">
              ...
              <div class="progress__moving">
                <div
                  ...
                  style={{
                    width: "20%",
                    marginLeft: `${props.state.movingPercentage}%`,
                  }}
                ></div>
              </div>
            </div>
            <div class="cancel__moving">
              <a href="#">
                <img src="/assets/cancelmove.svg" alt="cancelmode" />
              </a>
            </div>
          </div>
        </td>
    ...
    return (
      ...
      >
        ...
        <td class="name__row">
          <div class="inner__name--row">
            <span class="extension__wrap noSelect">
              {extensionImageResults.passed ? (
                <img src={extensionImageResults.ext} alt="accessimage" />
              ) : (
                <div
                  className="no-extension__wrapper"
                  style={{ background: extensionImageResults.color }}
                >
            ...
            <p className="name__row-filename noSelect">
              {props.state.editNameMode
                ? ""
            ...
            {props.state.editNameMode ? (
              <div onClick={props.clickStopPropagation} class="edit__name">
                <input
                  ...
                  onChange={props.changeEditName}
                />
                <a onClick={props.saveNameEdit} class="edit__save">
                  SAVE
                </a>
              </div>
            ) : undefined}
        ...
        <td class="location__row noSelect">Amazon S3</td>
          ...
          {props.state.deleteMode ? (
            <div onClick={props.clickStopPropagation} class="delete__wrap">
              ...
              <div class="delete__buttons">
                <a onClick={props.startDeleteFile} class="delete__button">
                  Delete
                </a>
                <a onClick={props.removeDeleteMode} class="keep__button">
                  Keep File
                </a>
              </div>
            </div>
