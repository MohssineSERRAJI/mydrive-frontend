...
import FailedSvg from "../../assets/uploaded__failed.svg";
import SuccessIcon from "../../assets/uploaded__success.svg";
  ...
  if (!completed && !canceled) {
    ...
    return (
      <div class="elem__upload uploaded__already">
        <div class="upload__elem--status">
          <span>
            <img src={SuccessIcon} alt="upload" />
          </span>
        </div>
        <div class="upload__info">
          <div class="top__upload">
