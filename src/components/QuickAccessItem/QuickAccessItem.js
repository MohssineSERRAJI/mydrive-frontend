...
const QuickAccessItem = (props) => (
  <div
    className={
      "quick-" + props.pk !== props.selected
        ? "elem__access noSelect"
        : "elem__access active__recent noSelect"
    }
    onClick={() => {
      props.fileClick(props.pk, props, true);
    }}
  ...
  >
    ...
    <div class="access__image">
      <img
        className={props.state.imageClassname}
    ...
    <div class="access__info--file">
      <p
        className="noSelect"
        style={"quick-" + props.pk !== props.selected ? {} : { color: "white" }}
      >
      ...
      <span
        ...
        style={"quick-" + props.pk !== props.selected ? {} : { color: "white" }}
      >
        Created {moment(props.fields.upload_date).calendar()}
      </span>
    </div>
  </div>
);
